...
import { getDataStructureById } from 'apiSdk/data-structures';
...
function DataStructureViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Data Structure Detail View
          </Text>
          {hasAccess('data_structure', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/data-structures/edit/${data?.id}`} passHref legacyBehavior>
              <Button
